...
Class VJoy
    ...
    Private Shared Function VJoy_Initialize32(ByVal name As StringBuilder, ByVal serial As StringBuilder) As <MarshalAs(UnmanagedType.Bool)> Boolean
    End Function
    ...
    Private Shared Function VJoy_Initialize64(ByVal name As StringBuilder, ByVal serial As StringBuilder) As <MarshalAs(UnmanagedType.Bool)> Boolean
    End Function
